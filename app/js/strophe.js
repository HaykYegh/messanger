...
Strophe.Builder = function (name, attrs) {
    ...
    if (((typeof attrs.id === "string") && attrs.id.startsWith('block') === false) && (name === "presence" || name === "message" || name === "iq")) {
...
Strophe.Connection.prototype = {
    ...
    connect: function (jid, pass, callback, wait, hold, route, authcid) {
        ...
        window.ipcRenderer.send("onLogs", {
            level: "info",
            meta: {
                status: "CONNECTING",
                method: "connect"
            },
            message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
            action: "LOG"
        });
    ...
    */
    ...
    disconnect: function (reason) {
        ...
        if (this.connected) {
            ...
            window.ipcRenderer.send("onLogs", {
                ...
                meta: {
                    reason,
                    method: "disconnect 3 _doDisconnect",
                },
                message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                action: "LOG"
            });
    ...
    _dataRecv: function (req, raw) {
        ...
        if (this.disconnecting && this._proto._emptyQueue()) {
            ...
            window.ipcRenderer.send("onLogs", {
                level: "info",
                meta: {
                    method: "_dataRecv 1 _doDisconnect",
                },
                message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                action: "LOG"
            });
        ...
        if (type !== null && type === "terminate") {
            ...
            window.ipcRenderer.send("onLogs", {
                level: "info",
                meta: {
                    method: "_dataRecv 2 _doDisconnect",
                },
                message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                action: "LOG"
            });
    ...
    _connect_cb: function (req, _callback, raw) {
        ...
        try {
            ...
            window.ipcRenderer.send("onLogs", {
                level: "info",
                meta: {
                    method: "_connect_cb _doDisconnect",
                },
                message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                action: "LOG"
            });
    ...
    _onDisconnectTimeout: function () {
        ...
        window.ipcRenderer.send("onLogs", {
            level: "info",
            meta: {
                method: "_onDisconnectTimeout _doDisconnect",
            },
            message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
            action: "LOG"
        });
        ...
        if (reqStatus === 200) {
            ...
            if (reqStatus >= 400 && reqStatus < 500) {
                ...
                window.ipcRenderer.send("onLogs", {
                    level: "info",
                    meta: {
                        method: "_onRequestStateChange _doDisconnect",
                    },
                    message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                    action: "LOG"
                });
...
Strophe.Websocket.prototype = {
    ...
    _check_streamerror: function (bodyWrap, connectstatus) {
        ...
        window.ipcRenderer.send("onLogs", {
            level: "info",
            meta: {
                method: "_check_streamerror _doDisconnect",
                connectstatus,
                condition
            },
            message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
    ...
    _handleStreamStart: function(message) {
        ...
        if (error) {
            ...
            window.ipcRenderer.send("onLogs", {
                level: "info",
                meta: {
                    method: "_handleStreamStart _doDisconnect",
                },
                message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                action: "LOG"
            });
        ...
        if (message.data.indexOf("<open ") === 0 || message.data.indexOf("<?xml") === 0) {
            ...
            if (see_uri) {
                ...
                window.ipcRenderer.send("onLogs", {
                    level: "info",
                    meta: {
                        method: "_connect_cb_wrapper 3 _connect",
                    },
                    message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                    action: "LOG"
                });
                ...
                window.ipcRenderer.send("onLogs", {
                    level: "info",
                    meta: {
                        method: "_connect_cb_wrapper _doDisconnect",
                    },
                    message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                    action: "LOG"
                });
    ...
    _disconnect: function (pres) {
        ...
        window.ipcRenderer.send("onLogs", {
            level: "info",
            meta: {
                method: "_disconnect _doDisconnect",
            },
            message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
            action: "LOG"
        });
    ...
    _onClose: function(e) {
        if(this._conn.connected && !this._conn.disconnecting) {
            ...
            window.ipcRenderer.send("onLogs", {
                level: "info",
                meta: {
                    errorInfo: "Websocket closed unexpectedly",
                    method: "_onClose 1 _doDisconnect",
                },
                message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                action: "LOG"
            });
            ...
            window.ipcRenderer.send("onLogs", {
                level: "info",
                meta: {
                    errorInfo: "The WebSocket connection could not be established or was disconnected.",
                    method: "_onClose 2 _doDisconnect",
                },
                message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                action: "LOG"
            });
    ...
    _no_auth_received: function (_callback) {
        ...
        window.ipcRenderer.send("onLogs", {
            level: "info",
            meta: {
                method: "_no_auth_received _doDisconnect",
            },
            message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
            action: "LOG"
        });
    ...
    _onError: function(error) {
        ...
        window.ipcRenderer.send("onLogs", {
            level: "info",
            meta: {
                openInfo: "The WebSocket connection could not be established or was disconnected.",
                status: "CONNFAIL",
                method: "_onError",
            },
            message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
        ...
        if (message.data === close) {
            ...
            if (!this._conn.disconnecting) {
                ...
                window.ipcRenderer.send("onLogs", {
                    level: "info",
                    meta: {
                        method: "_onMessage _doDisconnect",
                    },
                    message: "strophe.js" + " " + event.toLocaleTimeString('en-US'),
                    action: "LOG"
                });
