...
import {SettingsIconClose} from "containers/settings/style";
...
export default class SendLocation extends React.Component<ISendLocationProps, ISendLocationState> {
    ...
    initialize = () => {
        ...
        this.map = new (window as any).google.maps.Map(this.mapContainer.current, {
            center: {lat, lng},
            zoom: 14,
        });
    ...
    render(): JSX.Element {
        ...
        const {closePopUp, handleMediaKeyDown, language} = this.props;
        const localization: any = components(true)[language].locationPicker;

        return (
            <div className="media-popup show" onKeyDown={handleMediaKeyDown} tabIndex={0} id="media-popup">
                <div className="media-popup-content">
                    <div onClick={closePopUp} className="header-popup right_side_header location_header">
                        <div className="chat_status_wrapper location_wrapper">
                    ...
                    <div className="image_block"
                        ...
                        <div style={{width: "100%", height: "100%"}} ref={this.mapContainer}/>
