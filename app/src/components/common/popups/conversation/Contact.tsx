...
export default class Contact extends React.Component<IContactProps, IContactState> {
    ...
    render() {
        const {contact, selectedContactsCount, isSelected = false, showSelection} = this.props;
        ...
        const contactName = APPLICATION.WITHEMAIL ? contact.email : contact.username
        return (
                    ...
                    <div className="contact-content">
                        ...
                        <div className="text-block">
                            ...
                            <div className={`user-info ${!contact.firstName && !contact.lastName ? "no-name" : ""}`}>
                                {`${phoneMask(username)}` || `${phoneMask(username)}`}
                            </div>
                        </div>
