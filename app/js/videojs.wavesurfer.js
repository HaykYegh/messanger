...
}(this, function (videojs, WaveSurfer)
{
    ...
    /**
     * Draw a waveform for audio and photo files in a photo.js player.
     * @class
    ...
    videojs.Waveform = videojs.extend(VjsComponent,
    {
        ...
        setupUI: function()
        {
            ...
            // since photo.js 5.11.0 the player won't start if no src is
        ...
        play: function()
        {
            ...
            else
            {
                ...
                // put photo.js player UI in playback mode
                this.player().play();
